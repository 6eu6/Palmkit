...
We have also launched an experimental agent called the "palmkit.app Expert" that can answer common questions about palmkit.app. Find it here on the [oTTomator Live Agent Studio](https://studio.ottomator.ai/).

palmkit.app was originally started by [Cole Medin](https://www.youtube.com/@ColeMedin) but has quickly grown into a massive community effort to build the BEST open source AI coding assistant!
...
[Join the palmkit.app community here, in the oTTomator Think Tank!](https://thinktank.ottomator.ai)

## Project management

Palmkit is a community effort! Still, the core team of contributors aims at organizing the project in way that allows
...
[![Download Latest Release](https://img.shields.io/github/v/release/6eu6/Palmkit?label=Download%20Palmkit&sort=semver)](https://github.com/6eu6/Palmkit/releases/latest) ← Click here to go to the latest release version!
...
For users who prefer a native desktop experience, palmkit.app is also available as an Electron desktop application:

1. **Download the Desktop App**:
   - Visit the [latest release](https://github.com/6eu6/Palmkit/releases/latest)
...
Palmkit features a modern, intuitive settings interface for managing AI providers and API keys. The settings are organized into dedicated panels for easy navigation and configuration.
...
Palmkit supports both methods for maximum flexibility:
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone -b stable https://github.com/6eu6/Palmkit.git
   ```
...
>     - Explanation: The System Prompt currently implemented in palmkit.app cant cover the best performance for all providers and models out there. So it works better with some models, then other, even if the models itself are perfect for >programming
