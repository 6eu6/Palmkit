...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('palmkit_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('palmkit_profile', JSON.stringify(profileStore.get()));
  }
};
