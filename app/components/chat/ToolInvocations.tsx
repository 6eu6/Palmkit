...
export const ToolInvocations = memo(({ toolInvocations, toolCallAnnotations, addToolResult }: ToolInvocationsProps) => {
  ...
  return (
    <div className="tool-invocation border border-palmkit-elements-borderColor flex flex-col overflow-hidden rounded-lg w-full transition-border duration-150">
      <div className="flex">
        <button
          className="flex items-stretch bg-palmkit-elements-background-depth-2 hover:bg-palmkit-elements-artifacts-backgroundHover w-full overflow-hidden"
          onClick={toggleDetails}
          aria-label={showDetails ? 'Collapse details' : 'Expand details'}
        >
          <div className="p-2.5">
            <div className="i-ph:wrench text-xl text-palmkit-elements-textSecondary hover:text-palmkit-elements-textPrimary transition-colors"></div>
          </div>
          <div className="p-2.5 w-full text-left">
            <div className="w-full text-palmkit-elements-textPrimary font-medium leading-5 text-sm">
              MCP Tool Invocations{' '}
              {hasToolResults && (
                <span className="w-full w-full text-palmkit-elements-textSecondary text-xs mt-0.5">
        ...
        <AnimatePresence>
          {hasToolResults && (
            <motion.button
              ...
              className="bg-palmkit-elements-artifacts-background hover:bg-palmkit-elements-artifacts-backgroundHover"
              onClick={toggleDetails}
            >
              <div className="p-2">
                <div
                  className={`${showDetails ? 'i-ph:caret-up-bold' : 'i-ph:caret-down-bold'} text-xl text-palmkit-elements-textSecondary hover:text-palmkit-elements-textPrimary transition-colors`}
                ></div>
              </div>
            </motion.button>
          )}
      ...
      <AnimatePresence>
        {hasToolCalls && (
          ...
          >
            <div className="bg-palmkit-elements-artifacts-borderColor h-[1px]" />

            <div className="px-3 py-3 text-left bg-palmkit-elements-background-depth-2">
              <ToolCallsList
        ...
        {hasToolResults && showDetails && (
          ...
          >
            ...
            <div className="p-5 text-left bg-palmkit-elements-actions-background">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-1.5 text-xs mb-1">
                {isErrorResult ? (
                  <div className="text-lg text-palmkit-elements-icon-error">
                    <div className="i-ph:x"></div>
                  </div>
                ) : (
                  <div className="text-lg text-palmkit-elements-icon-success">
                    <div className="i-ph:check"></div>
                  </div>
                )}
                <div className="text-palmkit-elements-textSecondary text-xs">Server:</div>
                <div className="text-palmkit-elements-textPrimary font-semibold">{annotation?.serverName}</div>
              </div>

              <div className="ml-6 mb-2">
                <div className="text-palmkit-elements-textSecondary text-xs mb-1">
                  Tool: <span className="text-palmkit-elements-textPrimary font-semibold">{toolName}</span>
                </div>
                <div className="text-palmkit-elements-textSecondary text-xs mb-1">
                  Description:{' '}
                  <span className="text-palmkit-elements-textPrimary font-semibold">{annotation?.toolDescription}</span>
                </div>
                <div className="text-palmkit-elements-textSecondary text-xs mb-1">Parameters:</div>
      ...
      <ul className="list-none space-y-4">
        {toolInvocations.map((tool, index) => {
          ...
          return (
            ...
            >
              <div className="bg-palmkit-elements-background-depth-3 rounded-lg p-2">
                <div key={toolCallId} className="flex gap-1">
                  <div className="flex flex-col items-center ">
                    <span className="mr-auto font-light font-normal text-md text-palmkit-elements-textPrimary rounded-md">
                      {toolName}
                    </span>
                    <span className="text-xs text-palmkit-elements-textSecondary font-light break-words max-w-64">
                  ...
                  <div className="flex items-center justify-end gap-2 ml-auto">
                    ...
                    <button
                      className={classNames(
                        ...
                        'text-gray-700 dark:text-gray-300 hover:text-palmkit-elements-textPrimary',
