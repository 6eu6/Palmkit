      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-palmkit-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-palmkit-elements-item-backgroundAccent hover:bg-palmkit-elements-artifacts-backgroundHover"
