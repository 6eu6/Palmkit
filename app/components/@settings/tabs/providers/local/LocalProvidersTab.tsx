          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-palmkit-elements-background-depth-2 hover:bg-palmkit-elements-background-depth-3 border-palmkit-elements-borderColor hover:border-purple-500/30 transition-all duration-200 gap-2"
              >
