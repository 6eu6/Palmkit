          ...
          <div className="flex items-start gap-6 mb-8">
            <div
              className={classNames(
                ...
                'hover:ring-gray-500/30 dark:hover:ring-gray-500/30',
            ...
            >
              {profile.avatar ? (
                ...
                <div className="i-ph:robot-fill w-16 h-16 text-gray-400 dark:text-gray-500 transition-colors group-hover:text-gray-600/70 transform -translate-y-1" />
              )}
          ...
          <div className="mb-6">
            ...
            <div className="relative group">
              <div className="absolute left-3.5 top-1/2 -translate-y-1/2">
                <div className="i-ph:user-circle-fill w-5 h-5 text-gray-400 dark:text-gray-500 transition-colors group-focus-within:text-gray-600" />
              </div>
              <input
                type="text"
          ...
          <div className="mb-8">
            ...
            <div className="relative group">
              <div className="absolute left-3.5 top-3">
                <div className="i-ph:text-aa w-5 h-5 text-gray-400 dark:text-gray-500 transition-colors group-focus-within:text-gray-600" />
              </div>
              <textarea
                value={profile.bio}
