    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-palmkit-elements-textPrimary">GitHub Integration</h2>
        </div>
    ...
    <GitHubErrorBoundary>
      <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-palmkit-elements-background dark:bg-palmkit-elements-background-depth-2 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor hover:border-palmkit-elements-borderColorActive/70 dark:hover:border-palmkit-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-palmkit-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-palmkit-elements-textSecondary hover:text-palmkit-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-palmkit-elements-borderColor">
