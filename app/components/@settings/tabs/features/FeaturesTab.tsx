      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-palmkit-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-palmkit-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-palmkit-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-palmkit-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
  ...
  ({
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-lg font-medium text-palmkit-elements-textPrimary">{title}</h3>
          <p className="text-sm text-palmkit-elements-textSecondary">{description}</p>
        </div>
      </div>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-palmkit-elements-textPrimary group-hover:text-purple-500 transition-colors">
              Prompt Library
            </h4>
