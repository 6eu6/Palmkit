...
// Create a custom hook to connect to the palmkitHistory database
function usePalmkitHistoryDB() {
...
export function DataTab() {
  // Use our custom hook for the palmkitHistory database
  const { db, isLoading: dbLoading } = usePalmkitHistoryDB();
  ...
  // Data operations hook with palmkitHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the palmkitHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from palmkitHistory database', {
        name: db.name,
        version: db.version,
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Chats Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-palmkit-elements-textPrimary">Chats</h2>
        {dbLoading ? (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  <motion.div className="text-gray-700 dark:text-gray-300 mr-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                    <div className="i-ph-download-duotone w-5 h-5" />
                  </motion.div>
                  <CardTitle className="text-lg group-hover:text-palmkit-elements-item-contentAccent transition-colors">
                    Export All Chats
                  </CardTitle>
                </div>
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    className={classNames(
                      'hover:text-palmkit-elements-item-contentAccent hover:border-palmkit-elements-item-backgroundAccent hover:bg-palmkit-elements-item-backgroundAccent transition-colors w-full justify-center',
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-palmkit-elements-textPrimary">Settings</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-palmkit-elements-textPrimary">API Keys</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-palmkit-elements-textPrimary">Data Usage</h2>
        <Card>
