  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-palmkit-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-palmkit-elements-background-depth-2 border-y border-palmkit-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-palmkit-elements-terminals-buttonBackground text-palmkit-elements-textSecondary hover:text-palmkit-elements-textPrimary':
                            isActive,
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-palmkit-elements-textTertiary hover:text-palmkit-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachPalmkitTerminal(terminal);
                  } else {
