    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from Palmkit' : 'Update from Palmkit',
          tree: treeData.sha,
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-palmkit-elements-background-depth-1 rounded-lg border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark">
                          Successfully pushed to GitHub
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-palmkit-elements-textTertiary hover:text-palmkit-elements-textPrimary dark:text-palmkit-elements-textTertiary-dark dark:hover:text-palmkit-elements-textPrimary-dark hover:bg-palmkit-elements-background-depth-2 dark:hover:bg-palmkit-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-palmkit-elements-borderColor dark:focus:ring-palmkit-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 rounded-lg p-4 text-left border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark">
                    <p className="text-sm font-medium text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:github-logo w-4 h-4 text-gray-600" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-palmkit-elements-background-depth-1 dark:bg-palmkit-elements-background-depth-4 px-3 py-2 rounded border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-palmkit-elements-textSecondary hover:text-palmkit-elements-textPrimary dark:text-palmkit-elements-textSecondary-dark dark:hover:text-palmkit-elements-textPrimary-dark bg-palmkit-elements-background-depth-1 dark:bg-palmkit-elements-background-depth-4 rounded-lg border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark"
                  ...
                  <div className="bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 rounded-lg p-4 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark">
                    <p className="text-sm font-medium text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:files w-4 h-4 text-gray-600" />
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark border-b border-palmkit-elements-borderColor/30 dark:border-palmkit-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-palmkit-elements-background-depth-3 dark:bg-palmkit-elements-background-depth-4 text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark ml-2">
                            {(file.size / 1024).toFixed(1)} KB
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <motion.a
                      ...
                      className="px-4 py-2 rounded-lg bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-900 hover:bg-gray-700 dark:hover:bg-gray-300 text-sm inline-flex items-center gap-2"
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark hover:bg-palmkit-elements-background-depth-3 dark:hover:bg-palmkit-elements-background-depth-4 text-sm inline-flex items-center gap-2 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:copy w-4 h-4" />
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="px-4 py-2 rounded-lg bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark hover:bg-palmkit-elements-background-depth-3 dark:hover:bg-palmkit-elements-background-depth-4 text-sm border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-palmkit-elements-background-depth-1 rounded-lg p-6 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark shadow-xl"
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-palmkit-elements-background-depth-3 flex items-center justify-center text-gray-600"
                  >
                  ...
                  <p
                    ...
                    className="text-sm text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitHub, you need to connect your GitHub account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark text-sm hover:bg-palmkit-elements-background-depth-3 dark:hover:bg-palmkit-elements-background-depth-4 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-gray-600 text-white text-sm hover:bg-gray-600 inline-flex items-center gap-2"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:github-logo w-4 h-4" />
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-palmkit-elements-background-depth-3 flex items-center justify-center text-gray-600"
                  >
                    <div className="i-ph:github-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark">
                      Deploy to GitHub
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 rounded-lg border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark">
                  <div className="relative">
                    <img src={user.avatar_url} alt={user.login} className="w-10 h-10 rounded-full" />
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-gray-600 flex items-center justify-center text-white">
                      <div className="i-ph:github-logo w-3 h-3" />
                    </div>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark">
                      {user.name || user.login}
                    </p>
                    <p className="text-sm text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark">
                      @{user.login}
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-palmkit-elements-textTertiary dark:text-palmkit-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark placeholder-palmkit-elements-textTertiary dark:placeholder-palmkit-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-gray-500"
                        required
                        maxLength={100}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-palmkit-elements-textTertiary dark:text-palmkit-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 hover:bg-palmkit-elements-background-depth-3 dark:hover:bg-palmkit-elements-background-depth-4 transition-colors group border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark hover:border-gray-500/30"
                              whileHover={{ scale: 1.01 }}
                              whileTap={{ scale: 0.99 }}
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <div className="i-ph:git-branch w-4 h-4 text-gray-600" />
                                  <span className="text-sm font-medium text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark group-hover:text-gray-600">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-palmkit-elements-textSecondary dark:text-palmkit-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-palmkit-elements-background-depth-2 dark:bg-palmkit-elements-background-depth-3 rounded-lg border border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-palmkit-elements-borderColor dark:border-palmkit-elements-borderColor-dark text-gray-600 focus:ring-gray-500 dark:bg-palmkit-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-palmkit-elements-textPrimary dark:text-palmkit-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-palmkit-elements-textTertiary dark:text-palmkit-elements-textTertiary-dark mt-2 ml-6">
                  ...
                  <div className="pt-4 flex gap-2">
                    ...
                    <motion.button
                      ...
                      className={classNames(
                        'flex-1 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-600 text-sm inline-flex items-center justify-center gap-2',
